...
import {Form, Button, Modal, ModalHeader, ModalBody, Row, Col, Label, CardImg, ModalFooter} from "reactstrap";
...
const PageSingleSong = () => {
  ...
  const {control, handleSubmit, formState: {errors}, watch, reset, setValue, register} = useForm({
  ...
  return (
      <>
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <div>
                ...
                <Play onClick={() => listerToMusic(songInfo)} style={{cursor: 'pointer', color: '#1200ff'}}/>
                <Music onClick={ () => {
                  toggle()
                ...
                <div className="sc-gjtWyx idAWVU">
            ...
            <div className="chWPSK">
              <div className="sc-dNvYHJ bwIDZC w3-col">
                ...
                <div className="sc-gpQvLH gOzSIw __3dot-content">{songInfo?.singerName}</div>
                <div>
                  {
                    checkLike ?
            ...
            <div>
              ...
              <div className="action">
                <h3 className="subtitle has-text-weight-bold">21 Bình luận</h3>
              </div>
              <Form onSubmit={handleSubmit(onSubmit)} class="box_form_comment form-comment-0 mb-5">
                      ...
                      <div className="media comment-item mt-3">
                        ...
                        <div className="media-content">
                          <div className="username">
                            {el.userName} <span className="post-time">{el.createDate}</span>
                          </div>
        ...
        <Modal size="lg" isOpen={modal} style={{maxWidth: '1600px', width: '80%'}} centered={true}>
          ...
          <AddSongPlayList songIdAdd={songId} toggleSelect={toggle}></AddSongPlayList>
        </Modal>
