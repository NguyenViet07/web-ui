      ...
      <>
        <Container>
          ...
          <Row>
            ...
            <br />
              {logo ? <img class="sc-jgPznn ivASVi" src={logo} /> : <img class="sc-jgPznn ivASVi" src="/imgs/logo.png" />}

              {
                  userInfoView?.isSinger === 1 && <>
                      <h1>Là một ca sĩ </h1>
                      {
                          userInfoView?.company ? <h1> trực thuộc quản lý của công ty: { userInfoView?.company}</h1> : <h1> tự do </h1>
